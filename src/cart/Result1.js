...
export default function Result1() {
    ...
    if (price <= 0) {
        ...
        priceComma = price?.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
    }
    //일일
    let day = month / 30
    ...
    if (bank > total | month + bank > total) {
                ...
                <div className="flex justify-center">
                    <div className="m-4 pt-4 pr-4 pl-4 pb-2 border  rounded-md bg-white shadow-md max-w-sm text-center">
                        ...
                        <div className="m-4">
                            ...
                            <div className="text-2xl font-semibold ">이미 구입하실 수 있어요</div>
                            <br />
            ...
            <>
                <div className="flex justify-center">
                    <div className="m-4 pt-4 pr-4 pl-4 pb-2 border  rounded-md bg-white shadow-md max-w-sm text-center">
                        ...
                        <div className="m-4">
                            <span className="font-semibold text-base bg-black opacity-80 p-1 m-1 text-white">구매까지 필요한 금액</span>
                            <div className="text-2xl font-semibold ">다음 달이면 살 수 있어요</div>
                            <br />
