    ...
    return (
        <>
            ...
            <form>
                ...
                <input type="number" name="age" id="age" value={age} onChange={(e) => setAge(e.target.value)} min={0} />세<br />
                <label htmlFor='month'>월 저축액 </label><br />
                <input type="number" name="month" id="month" value={month} onChange={(e) => setMonth(e.target.value)} min={0} />만원<br />
                <label htmlFor='bank'>은행 잔고 </label><br />
                <input type="number" name="bank" id="bank" value={bank} onChange={(e) => setBank(e.target.value)} min={0} />만원<br />
